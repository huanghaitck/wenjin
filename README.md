...
问津核心程序不绑定具体研究对象。领域包可以扩展研究方法、字段规范、资料处理器、知识图谱、本地数据接口与Agent工具。
...
在“AI 与 Agent—连接器与 MCP”中生成二维码并用普通微信扫码，即可从微信继续当前项目的私聊研究对话。只有获准联系人能够使用。登录信息保存在Windows安全凭据中，不写入研究项目。

...
function renderKnowledgeGraph(data){
  ...
  const categoryLabels=english?{primary_sources:'Primary sources',academic_articles:'Articles',monographs:'Monographs',personal_manuscripts:'Personal papers',reading_notes:'Reading notes',reference_works:'Reference works',unclassified:'Unclassified'}:{primary_sources:'原始史料',academic_articles:'期刊论文',monographs:'学术专著',personal_manuscripts:'本人文章与稿件',reading_notes:'读书笔记',reference_works:'工具书',unclassified:'待分类'};
